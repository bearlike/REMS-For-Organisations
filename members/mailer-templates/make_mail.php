<?php
function make_mail($body,$title,$BUTTON_LINK,$BUTTON_LABEL,$LogoURL,$coverImageURL){
    $email= '<!DOCTYPE html
      ...
      <tr>
        <td>
          ...
          <div>
            ...
            <div
              style="background-color: #18527c;background: 71% 57%/cover no-repeat url('.$coverImageURL.') #18527c;background-position: 71% 57%;background-image: url('.$coverImageURL.');background-repeat: no-repeat;background-size: cover;">
              <div class="layout one-col stack"
                style="Margin: 0 auto;max-width: 600px;min-width: 320px; width: 320px;width: calc(28000% - 167400px);overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;">
                <div class="layout__inner" style="border-collapse: collapse;display: table;width: 100%;">
                  <!--[if (mso)|(IE)]><table width="100%" cellpadding="0" cellspacing="0" role="presentation"><tr class="layout-full-width" style="background: 71% 57%/cover no-repeat url('.$coverImageURL.') #18527c;background-position: 71% 57%;background-image: url(https://i1.createsend1.com/ei/t/D0/3B3/085/040656/csfinal/assg3.jpeg);background-repeat: no-repeat;background-size: cover;background-color: #18527c;"><td class="layout__edges">&nbsp;</td><td style="width: 600px" class="w560"><![endif]-->
                  <div class="column"
                    style="text-align: left;color: #8e959c;font-size: 14px;line-height: 21px;font-family: sans-serif;">
                    ...
                    <div style="Margin-left: 20px;Margin-right: 20px;">
                      <div style="mso-line-height-rule: exactly;mso-text-raise: 11px;vertical-align: middle;">
                        <h1 class="size-64"
                          style="mso-text-raise: 25px;Margin-top: 0;Margin-bottom: 20px;font-style: normal;font-weight: normal;color: #000;font-size: 44px;line-height: 50px;font-family: avenir,sans-serif;text-align: center;"
                          lang="x-size-64"><span class="font-avenir"><strong><span style="color:#ffffff">
                            '.$title.'</span></strong></span></h1>
                      </div>
                    </div>
                  ...
                  <div style="Margin-left: 20px;Margin-right: 20px;">
                    <div style="mso-line-height-rule: exactly;mso-text-raise: 11px;vertical-align: middle;">
                      <h2
                        ...
                        <strong>Greetings from SVCE ACM Student Chapter</strong></h2>
                    </div>
                  </div>
            ...
            <div class="layout one-col fixed-width stack"
              ...
              <div class="layout__inner"
                ...
                <div class="column"
                  ...
                  <div style="Margin-left: 20px;Margin-right: 20px;">
                    <div style="mso-line-height-rule: exactly;mso-text-raise: 11px;vertical-align: middle;">
                      <p style="Margin-top: 0;Margin-bottom: 0;"><span style="color:#000000">'.$body.'</span></p>
