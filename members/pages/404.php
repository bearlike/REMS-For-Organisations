...
<head id="head_tag">
    ...
    <title>Page Not Found:<?php echo " ".$OrgName; ?></title>
		...
		<?php include("../navigation.php"); ?>
            <div class="container-fluid">
                <div class="text-center mt-5">
                    ...
                    <p class="text-black-50 mb-0">It looks like you found a glitch in the matrix...</p><a href="../dashboard.php">← Back to Dashboard</a></div>
            </div>
        </div>
