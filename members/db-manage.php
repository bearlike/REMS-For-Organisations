                ...
                <div class="row">
                    <div class="col-md-6 col-xl-3 mb-4">
                        <form action="<?php echo $_SERVER["PHP_SELF"]; ?>" method="GET">
                            <select name="dbname">
                            	<option value="svcehost_cms">CMS database</option>
                            	<option value="svcehost_forms">Forms database</option>p
                            </select>
                        ...
                        <div class="table-responsive table mt-2" id="dataTable" role="grid" aria-describedby="dataTable_info">
                            <table class="table dataTable my-0" id="dataTable">
                                ...
                                <tbody>
                                    <?php
                                         if(!(empty($_GET['event']))){
                                         	echo '<tr><form action="db-ops/insert.php" method="post"><input type="hidden" value="'.$event.'" name="event_name"><input type="hidden" value="'.$dbname.'" name="dbname">';
                                         		foreach ($colArr as $col){
                                         	...
                                         	echo '<button type="sumit" class="btn btn-success ml-2 btn-sm"><i class="fas fa-plus text-white"></button></td>';
                                         	echo '</form></tr>';
                                            foreach ($registrants as $row){
                                                ...
                                                echo '<td align="center">
	                                                	<a href="db-ops/delete.php?event='.$event.'&id='.$row_id.'&dbname='.$dbname.'" class="btn btn-danger ml-2 btn-sm"><i class="fas fa-trash text-white"></i>
	                                                	</a>
	                                                	<div style="padding:10px;">
	                                                		<a href="db-ops/modify.php?tbname='.$event.'&id='.$row_id.'&dbname='.$dbname.'" class="btn btn-info ml-2 btn-sm"><i class="fas fa-edit text-white"></i></a>
	                                                	</div>
                                                	</td>';
