     ...
     <div id="wrapper">
          ...
          <div class="container-fluid">
               ...
               <form action="<?php echo $_SERVER["PHP_SELF"] ?>" method="post">
                    ...
                    <div class="form-row" id="subject" style="margin-left: 10px;margin-top: 14px;margin-right: 10px;">
                         <div class="col">
                              <div class="form-group"><input class="form-control form-control" type="text" placeholder="Title of the E-mail" required="" name="mail_title" id="mail_title">
                              </div>
                         </div>
                    </div>
                    <div class="form-row" id="subject" style="margin-left: 10px;margin-top: 14px;margin-right: 10px;">
                    ...
                    <div class="form-row" id="submit-btn" style="margin-left: 10px;margin-top: 14px;margin-right: 10px;">
                         <div class="col center">
                              <div class="form-group"><button class="btn btn-primary" type="submit" name="submit">&nbsp;<i class="fa fa-send"></i>&nbsp; &nbsp; &nbsp;Send
                                        Message&nbsp; &nbsp;</button></div>
                         </div>
                         <div class="col center">
                              <div class="form-group"><button class="btn btn-primary" type="button" onClick="preview()">&nbsp;<i class="fas fa-eye"></i>&nbsp; &nbsp; &nbsp;Preview
                                        message&nbsp; &nbsp;</button></div>
                         </div>
                    </div>
               </form>
