...
<head>
  ...
  <title>Certificate Distribution System (CDS): {{ org_name }}</title>
          ...
          <div class="card-body p-0">
            <div class="row">
              <div class="col-lg-6 d-none d-lg-flex">
                <div class="flex-grow-1 bg-password-image" style="background-image: url('{{ url_for('static', filename='assets/img/front/image2.png') }}');"></div>
              </div>
              <div class="col-lg-6">
                <div class="p-5">
                  ...
                  <form class="user" action="{{ url_for('public.home') }}" method="get">
                    <div class="form-group">
                      <input class="form-control form-control-user" type="text" placeholder="Enter Event Name..." name="event" required>
                    </div>
                    <button class="btn btn-primary btn-block text-white btn-user" type="submit">Search Event</button>
                  </form>
                  <div class="text-center">
                    <p class="mb-4 small" style="color: red;">
                      {% if event_not_found %}
                        Event not found. Are you sure you're spelling it right?
                      {% endif %}
                    </p>
                  </div>
                  <div class="text-center">
                  ...
                  <div class="text-center"><a class="small" href="{{ url_for('public.home') }}?mode">Don't Know the Event Name? Click here.</a></div>
                  <div class="text-center"><a class="small" href="{{ url_for('auth.login') }}">Are you a member? Login!</a></div>
                </div>
